...
f = open('sample_10MB.txt','r') # sample_10MB means that file size is of 10MB
msg= f.read()
f.close()
...
val1=pre.decryptFirstLevel(params,id_secret_key, ciphertext, ID)

re_encryption_key = pre.rkGen(params,id_secret_key, ID, ID2)
ciphertext2 = pre.reEncrypt(params, ID, re_encryption_key, ciphertext)
val2=pre.decryptSecondLevel(params,id2_secret_key,ID, ID2, ciphertext2)

if val1.decode()==val2.decode():
    print("Success")
