...
#print("Encryption Key Generated from ID of User-1:-- "+str(id1_secret_key))
...
#print("Re-Encryption key generated using the public key of User-2:-- "+str(re_encryption_key))
ciphertext2 = pre.reEncryptPKenc(params, re_encryption_key, ciphertext)
#print("Encrypted message to User-2:-- "+str(ciphertext2))
